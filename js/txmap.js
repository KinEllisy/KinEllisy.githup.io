...
$.ajax({
    ...
    data: {
        key: 'GJTBZ-MC2L3-SCC36-OFY6W-HTDKE-KMFRC',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(112.46163540246016, 34.62218181665867, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
