document.addEventListener("DOMContentLoaded", (function () {
    ...
    const c = i => {
        ...
        let c = "";
        c = window.innerWidth <= 768 || t + e + n > o.offsetWidth - 120,
    ...
    const d = function () {
        ...
        const i = document.getElementById("page-header")
            ...
            , a = btf.throttle((() => {
                ...
                a > 56 ? (l ? (i.classList.contains("nav-visible") && i.classList.remove("nav-visible"),
                    s && !0 === o && (chatBtnHide(),
                        o = !1)) : (i.classList.contains("nav-visible") || i.classList.add("nav-visible"),
                            c && !1 === o && (chatBtnShow(),
                                o = !0)),
                    i.classList.add("nav-fixed"),
                    "0" === window.getComputedStyle(t).getPropertyValue("opacity") && (t.style.cssText = "opacity: 0.8; transform: translateX(-58px)")) : (0 === a && i.classList.remove("nav-fixed", "nav-visible"),
                        t.style.cssText = "opacity: ''; transform: ''"),
                    document.body.scrollHeight <= e && (t.style.cssText = "opacity: 0.8; transform: translateX(-58px)")
            }
            ), 200);
        window.scrollCollect = a,
        ...
        , m = () => {
            "light" === ("dark" === document.documentElement.getAttribute("data-theme") ? "dark" : "light") ? (activateDarkMode(),
                ...
                "object" == typeof FB && window.loadFBComment && window.loadFBComment(),
